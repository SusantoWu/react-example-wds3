...
(function () {
    ...
    Array.prototype.indexOf ||
      ...
      navigator.sayswho.split("MSIE ")[1]
        ...
        : navigator.sayswho.split("Chrome ")[1] &&
          (sls.Browser.Chrome = navigator.sayswho
            .split("Chrome ")[1]
            .slice(0, 3)),
      sls.Browser.FF < 2 &&
        sls.Browser.MSIE < 6 &&
      ...
      (sls.InsertRequest.prototype.serialize = function () {
        for (
          var s = `${this.service},${this.name},${this.type},${this.seqNo}`,
            t = 0;
          t < this.fields.length;
          t++
        )
          s += `,${this.fields[t].field},${this.fields[t].offset},${this.flags},${this.fields[t].dataLength},${this.fields[t].value}`;
        return s;
      }),
        ...
        (sls.HttpConnection.prototype.request_record = function (s) {
          ...
          (sls.HttpConnection.prototype.destroy = function () {
            null !== this._websocket
              ? (this._websocket.close(), clearInterval(this._runID))
              : (this.sendClose(),
          ...
          (sls.HttpConnection.prototype.create_iframe = function (s) {
            ...
            return (
              ...
              document.documentMode < 9
                ? (t = document.createElement(`<iframe name="${s}" id="${s}">`))
          ...
          (sls.HttpConnection.prototype.getURI = function () {
            ...
            if (
              ((n =
                "" === this._auth
                  ? `${this._hostWDS}/JS3/${i.getTime()}/SlingShot2000/index.html`
                  : `${
                      this._hostWDS
                    }/JS3/${i.getTime()}/SlingShot2000/index.html?${this._auth}`),
              "" !== s)
            ) {
          ...
          (sls.HttpConnection.prototype.nextURI = function () {
            return (
              this._incCnt++,
              `${this._http + this._host}/JS3/CSK${this._incCnt}/SlingShot2000/${
                this._sig
              }/${this._id}`
            );
          }),
          (sls.HttpConnection.prototype.nextWsURI = function () {
            return (
              this._incCnt++,
              `${this._ws + this._host}/CSK${this._incCnt}/SlingShot2000/${
                this._sig
              }/${this._id}`
            );
          }),
          ...
          (sls.HttpConnection.prototype.processConnect = function () {
            if (
              ...
              var s = `processConnect: recvClose = ${
                this._ctlFlags & this.FL_recvClose
              } , buffered =${this._ctlFlags & this.FL_buffered}`;
                    ...
                    for (n = 0; n < s.fids.length; n++)
                      if (
                        ...
                        if (
                          ...
                          this._cache[e].fids[s.fids[n].i].v =
                            _ + s.fids[n].v + d;
          ...
          (sls.HttpConnection.prototype.xa = function () {
            clearInterval(this._runID),
              this.callbacks.connection_status &&
                this.callbacks.connection_status(
                  sls.ConnectionStatus.Unauthorised,
                ),
              this.callbacks.debug_msg &&
          ...
          (sls.HttpConnection.prototype.onopen = function (s) {
            this.slsconn.callbacks.debug_msg &&
              this.slsconn.callbacks.debug_msg(s);
          }),
    ...
    (sls.get_version = function () {
      ...
      (sls.pause_updates = function (s) {
        return _sls_theHttpConnection
          ? _sls_theHttpConnection.pause_updates(s)
          : 1;
      }),
      (sls.resume_updates = function (s) {
        return _sls_theHttpConnection
          ? _sls_theHttpConnection.resume_updates()
          : 1;
      }),
